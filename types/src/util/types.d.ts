...
import { TimeAxisBaseOption } from '../coord/axisCommonTypes.js';
export { Dictionary };
...
export declare type ValueAxisTicksGenerator = (extent?: number[], interval?: number, niceTickExtent?: number[], intervalPrecision?: number) => ScaleTick[];
export declare type TimeAxisBandWidthCalculator = (model: AxisBaseModel<TimeAxisBaseOption>) => number;
