...
declare type ValueAxisTicksGenerator = (extent?: number[], interval?: number, niceTickExtent?: number[], intervalPrecision?: number) => ScaleTick[];
declare type TimeAxisBandWidthCalculator = (model: AxisBaseModel<TimeAxisBaseOption>) => number;
